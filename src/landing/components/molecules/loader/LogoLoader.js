...
const LogoLoader = ({ isLoader }) => {
    ...
    const SlidingShapes = () => {
        return (
            <div className="fixed top-0 bottom-0 left-0 right-0 z-30 bg-white-light overflow-hidden flex items-center justify-center">
                <div>
    ...
    return (
        <>
            <div className={`flex justify-center items-center fixed top-0 bottom-0 right-0 left-0 bg-white-light z-40 transition-opacity duration-300 ${isShow ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
