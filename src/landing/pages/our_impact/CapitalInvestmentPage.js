...
import { imgCPI1, imgCPI2, imgCPI3, ptCircle } from "../../assets";
import { Content } from "../../components";

const CapitalInvestmentPage = () => {
    const language = LandingLanguage[getLocalLanguage().key][RouteName.capitalInvestment];
    return (
        <Content navbar={{ style: "sticky top-0 bg-white-light" }}>
            ...
            <div className="grid grid-cols-3">
                <div className="flex justify-center items-center h-[25rem]">
                    <img src={imgCPI1} alt="assets" className="w-full h-full object-cover" />
                </div>
                <div className="flex justify-center items-center h-[25rem]">
                    <img src={imgCPI2} alt="assets" className="w-full h-full object-cover" />
                </div>
                <div className="flex justify-center items-center h-[25rem]">
                    <img src={imgCPI3} alt="assets" className="w-full h-full object-cover" />
                </div>
            </div>
        </Content>
    );
