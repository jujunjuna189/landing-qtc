...
import { imgASM1, imgASM2, imgASM3, ptCircle } from "../../assets";
import { Content } from "../../components";

const AssetManagementPage = () => {
    const language = LandingLanguage[getLocalLanguage().key][RouteName.assetManagement];
    return (
        <Content navbar={{ style: "sticky top-0 bg-white-light" }}>
            ...
            <div className="grid grid-cols-3">
                <div className="flex justify-center items-center h-[25rem]">
                    <img src={imgASM1} alt="assets" className="w-full h-full object-cover" />
                </div>
                <div className="flex justify-center items-center h-[25rem]">
                    <img src={imgASM2} alt="assets" className="w-full h-full object-cover" />
                </div>
                <div className="flex justify-center items-center h-[25rem]">
                    <img src={imgASM3} alt="assets" className="w-full h-full object-cover" />
                </div>
            </div>
        </Content>
    );
