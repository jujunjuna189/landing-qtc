    ...
    return (
        <Content navbar={{ style: "sticky top-0 bg-white-light" }}>
            ...
            <div className="relative">
                <img src={images[0]} alt="Image5" className="object-cover object-bottom w-full h-[70vh]" loading="lazy" />
            ...
            <div className="pt-32 pb-32 relative flex flex-row px-20">
                <div className="grow w-[50rem] flex justify-center">
                    <img src={images[1]} alt="Image5" className="object-contain object-bottom aspect-video h-[10rem]" loading="lazy" />
                </div>
