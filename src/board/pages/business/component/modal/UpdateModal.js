...
import { Button, FieldArea, FieldFile, FieldText } from "../../../../components";
import { updateBusinessApi } from "../../../../helpers";
...
const UpdateModal = (props) => {
    ...
    const onSave = async () => {
        ...
        await updateBusinessApi({ id: props.item?.id, body: dataBatch }).then((res) => {
            ...
            >
                ...
                >
                    <div className="leading-3">
                        <span className="text-base font-medium">Update Business</span>
                        <br />
                        ...
                        <div className="flex gap-5 items-center">
                            <div>
                                <div className="w-32 h-32 bg-slate-100 flex justify-center items-center relative">
                                    {controller?.logo?.preview && (<div className="w-full h-full absolute bg-slate-100">
                                        <img src={controller?.logo?.preview} alt="ImageProfile" className="object-contain w-full h-full" />
                                    </div>)}
                            ...
                            <div className="grow">
                                ...
                                <div className="flex">
                                    <FieldFile label="Upload Logo" onChange={(value) => onSetController({ field: 'logo', value: value })} />
                                    <span className="text-danger-dark">{errors.logo}</span>
                                </div>
                            </div>
                        </div>
                        <div className="mt-3">
