                    ...
                    <table className="w-full border-collapse">
                        ...
                        <tbody>
                            <tr className="hover:bg-white-muted">
                                ...
                                <td className="border-y-[1.5px] border-white-muted px-3 py-3 text-sm text-start">10 January 2025</td>
                                <td className="border-y-[1.5px] border-white-muted px-3 py-3 text-sm text-start">https://google.com</td>
                                <td className="border-y-[1.5px] border-white-muted px-3 py-3 text-sm text-start">
